...
struct StructuralCommand {
    ...
    glm::dvec4 m_color{1.0, 1.0, 1.0, 1.0};   // SetColor
    ...
    static StructuralCommand addCell(std::uint64_t gridId, const glm::ivec3& coord);
    ...
    static StructuralCommand spawnGrid(const glm::dvec3& position,
