...
MeshHandler::MeshHandler(size_t maxTriangles, SSBOManager* ssboManager)
   ...
   m_shaderProgram.loadVertexShaderFromPath("../src/graphics/meshHandler/mesh_vertex_shader.vert");
   m_shaderProgram.loadFragmentShaderFromPath("../src/graphics/shared_shaders/fragment_shader.frag");
   m_shaderProgram.linkShaders();

   // Load G-buffer shaders
   m_gbufferShaderProgram.loadVertexShaderFromPath("../src/graphics/meshHandler/mesh_vertex_shader.vert");
