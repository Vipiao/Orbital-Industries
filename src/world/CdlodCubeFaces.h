...
#include <vector>
#include <glm/glm.hpp>
#include "graphics/cdlod/CdlodTree.h"
 ...
 * the table below. It sits in the game because the renderer has no opinion about
 * what solid a body comes off; CubeSphereBounds and the snippet are the others.
 */
